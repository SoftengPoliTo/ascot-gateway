...
use crate::database::{
    all_devices, insert_device, insert_device_address, insert_device_property, Devices,
};
...
async fn devices_discovery(
    ...
    // TODO: Delete old devices present in the database

    // Run in search of devices and saves them into the database.
    save_device(receiver, db, uri).await?;
